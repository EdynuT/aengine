...
public final class SharedMemory {
    ...
    public static void init(int width, int height) {
        try {
            ...
            // O SEGREDO: Nome dinâmico baseado em tempo para fugir do "lock" do Windows
            String uniqueId = String.valueOf(System.nanoTime());
            String fileName = "aengine_viewport_" + uniqueId + ".raw";
            
            shmFile = new File(basePath, fileName);
            ...
            // Pede para o OS deletar o arquivo sozinho quando a engine for fechada
    ...
    public static void cleanup() {
        try {
            ...
            // Anulamos a referência para ajudar o Garbage Collector a matar o buffer antigo
            mappedBuffer = null; 
            
            if (shmFile != null && shmFile.exists()) {
                // Tentamos deletar. Se o Windows bloquear, não tem problema,
                // pois o próximo frame vai usar um arquivo com um nome novo!
                shmFile.delete(); 
            }
        } catch (Exception e) {
